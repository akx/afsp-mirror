...
Description:
  ...
  Combine Mode:
    ...
    2: If frame limits are specified, the number of frames is determined from
       the maximum number of frames specified for any one file.
  ...
  Concatenate Mode:
    ...
    1: If the number of output frames is specified, this value is used.
    2: The number of frames is the sum of the number of frames for each input
...
Author / revision:
  ...
  $Revision: 1.15 $  $Date: 2020/11/23 18:30:55 $
