...
Author / revision:
  ...
  $Revision: 2.119 $  $Date: 2020/11/12 18:35:03 $
...
void
MAiPrint(FILE *fp, const char Header[], const int *A[], int Nrow, int Ncol);
void
...
double
SPcovFmse(const float h[], double Ed, const float *R[], const float r[], int N);
double
...
int
STdecNlong(const char String[], int Nmin, int Nmax, long int Lval[], int *N);
int
...
void
VRdAmpldB(const double ampl[], double dB[], int N);
void
