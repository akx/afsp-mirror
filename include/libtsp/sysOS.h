...
Author / revision:
  ...
  $Revision: 1.15 $  $Date: 2017/06/09 13:10:15 $
...
/* Operating System
   ...
   - hybrid: Unix running under Windows (Cygwin)
     - file names: "/cygdrive/d/xxx/yyy"
     - files may or may not distinguish text files from binary files
     - Posix routines available ("unistd.h" for example)
*/
#define SY_OS_UNIX      0
...
#  define SY_FILENAMESPEC   SY_FNS_UNIX
#  define SY_POSIX           1
#elif (defined(_WIN32))
