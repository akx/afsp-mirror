...
/* For floating types, we have to assume the sizes, since the preprocessor does
   not allow floating constants or sizeof checks */
...
/*
 ...
 (short int, int, long int) are (2,2,4), (2,4,4) or (2,4,8) bytes if (long
 long int) is available, the standard cases are assumed to be (2,2,4,8)
 (2,4,4,8), and (2,4,8,8).
*/
#if (SHRT_MAX == 32767)
