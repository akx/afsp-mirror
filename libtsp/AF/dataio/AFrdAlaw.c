...
Routine:
  int AFrdAlaw (AFILE *AFp, float Fbuff[], int Nreq)
...
Author / revision:
  ...
  $Revision: 1.12 $  $Date: 1999/06/11 22:27:16 $

-------------------------------------------------------------------------*/

static char rcsid [] = "$Id: AFrdAlaw.c 1.12 1999/06/11 AFsp-v6r8 $";
