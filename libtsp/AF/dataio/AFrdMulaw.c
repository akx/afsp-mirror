...
Routine:
  int AFrdMulaw (AFILE *AFp, long int offs, float Fbuff[], int Nreq)
...
Author / revision:
  ...
  $Revision: 1.34 $  $Date: 1999/06/11 22:32:45 $

-------------------------------------------------------------------------*/

static char rcsid [] = "$Id: AFrdMulaw.c 1.34 1999/06/11 AFsp-v6r8 $";
