...
Routine:
  ...
  int AFdWrMulaw (AFILE *AFp, const double Dbuff[], int Nval)
  int AFdWrMulawR (AFILE *AFp, const double Dbuff[], int Nval)

Purpose:
  Write 8-bit A-law data to an audio file (double input values)
  Write 8-bit ,i-law data to an audio file (double input values)
  Write bit-reversed 8-bit A-law data to an audio file (double input values)
...
Author / revision:
  ...
  $Revision: 1.14 $  $Date: 2017/06/28 23:51:02 $
