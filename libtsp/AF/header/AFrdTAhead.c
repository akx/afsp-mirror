...
Description:
  This routine reads the header for a text audio file. The header information is
  ...
  Section 1:
    ...
    audio file information structure. Additional lines are stored as information
    records.
  Section 2:
...
Author / revision:
  ...
  $Revision: 1.71 $  $Date: 2020/11/26 11:29:47 $
...
/* Check for the file identifier */
  ...
  /* Compare with %//\n\0], length 5, or [%//\r\n\0] */
  if (line == NULL || !(SAME_CSTR(TA_IDu, line) || SAME_CSTR(TA_IDw, line))) {
