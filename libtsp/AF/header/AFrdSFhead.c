...
Description:
  ...
  For IRCAM files, text information in the header is stored as a "SF_COMMENT:"
  information record in the audio file parameter structure.
...
/* Notes:
   ...
   - The sox utility (as of version 11) has a compile time flag.  In the IRCAM
     ...
     In the non-IRCAM mode, the file magic is one of 4 values depending on the
     machine type (shown in file byte order),
        "\144\243\001\0"   vax   little-endian data
        "\144\243\002\0"   sun   big-endian data
        "\144\243\003\0"   mips  little-endian data
        "\144\243\004\0"   next  big-endian data
