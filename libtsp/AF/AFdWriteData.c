...
Description:
  This routine writes a specified number of samples to an audio file. The double
...
Author / revision:
  ...
  $Revision: 1.15 $  $Date: 2020/11/23 20:48:08 $
...
/* The file writing routines write scaled data to the file. They write to the
  ...
  This routine updates the following AFp values
    ...
    AFp->Isamp - current data sample. This value is incremented by the number of
      samples written.
